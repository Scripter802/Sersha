        ...
        <aside id="sidebar" className={openSidebarToggle ? "sidebar-responsive" : ""}>
            ...
            <ul className='sidebar-list'>
                <li className='sidebar-list-item'>
                    <div onClick={() => setActiveTab('Dashboard')} style={{ backgroundColor: `${activeTab === "Dashboard" ? "#C26F4D" : ""}` }}>
                        <span>🏠</span> Dashboard
                    </div>

                </li>
                <li className='sidebar-list-item'>
                    <div onClick={() => setActiveTab('Users')} style={{ backgroundColor: `${activeTab === "Users" ? "#C26F4D" : ""}` }}>
                        <img style={{ width: "20px" }} src={users} alt="" />Users
                    </div>
                </li>
                <li className='sidebar-list-item'>
                    <div onClick={() => setActiveTab('Posts')} style={{ backgroundColor: `${activeTab === "Posts" ? "#C26F4D" : ""}` }}>
                        <img style={{ width: "20px" }} src={newPost} alt="post image" /> Posts
                    </div>
                </li>
                <li className='sidebar-list-item'>
                    <div onClick={() => setActiveTab('DMs')} style={{ backgroundColor: `${activeTab === "DMs" ? "#C26F4D" : ""}` }}>
                        <span>💬</span> DMs
                    </div>
                </li>
                <li className='sidebar-list-item'>
                    <div onClick={() => setActiveTab('Quizzes')} style={{ backgroundColor: `${activeTab === "Quizzes" ? "#C26F4D" : ""}` }}>
                        <span>❓</span>  Quizzes
                    </div>
                </li>
                ...
                {activeTab === 'Quizzes' && (
                    <div className='adminQuizzesSubMenu'>
                        <li className='sidebar-list-item'>
                            <div onClick={() => setQuizzesActiveTab('Right Answer')} style={{ backgroundColor: `${quizzesActiveTab === "Right Answer" ? "#C26F4D" : ""}` }}>
                                <span>❓</span>  Right Answer
                            </div>
                        </li>
                        <li className='sidebar-list-item'>
                            <div onClick={() => setQuizzesActiveTab('Correct/Incorrect')} style={{ backgroundColor: `${quizzesActiveTab === "Correct/Incorrect" ? "#C26F4D" : ""}` }}>
                        ...
                        <li className='sidebar-list-item'>
                            <div onClick={() => setQuizzesActiveTab('Grouping')} style={{ backgroundColor: `${quizzesActiveTab === "Grouping" ? "#C26F4D" : ""}` }}>
                                <span><img style={{ height: "20px" }} className='groupingIcon' src={groupingIcon} alt="groupingIcon" /></span>  Grouping
                            </div>
                        </li>
                        <li className='sidebar-list-item'>
                            <div onClick={() => setQuizzesActiveTab('Fill In The Blank')} style={{ backgroundColor: `${quizzesActiveTab === "Fill In The Blank" ? "#C26F4D" : ""}` }}>
                ...
                <li className='sidebar-list-item'>
                    <div onClick={() => setActiveTab('Slideshows')} style={{ backgroundColor: `${activeTab === "Slideshows" ? "#C26F4D" : ""}` }}>
                        <span>🎞</span>  Slideshows
                    </div>
                </li>
                <li className='sidebar-list-item'>
                    <div onClick={() => setActiveTab('Clothing')} style={{ backgroundColor: `${activeTab === "Clothing" ? "#C26F4D" : ""}` }}>
                        <span>🦊</span>  Clothing
                    </div>
                </li>
                <li className='sidebar-list-item'>
                    <div onClick={() => setActiveTab('Snap Judgment')} style={{ backgroundColor: `${activeTab === "Snap Judgment" ? "#C26F4D" : ""}` }}>
                ...
                <li className='sidebar-list-item'>
                    <div onClick={() => setActiveTab('Emoji Emotions')} style={{ backgroundColor: `${activeTab === "Emoji Emotions" ? "#C26F4D" : ""}` }}>
                        <span>😀</span>  Emoji Emotions
                    </div>
                </li>
                <li className='sidebar-list-item'>
                    <div onClick={() => setActiveTab('Posting Challenge')} style={{ backgroundColor: `${activeTab === "Posting Challenge" ? "#C26F4D" : ""}` }}>
                        <span>📷</span>  Posting Challenge
                    </div>
                </li>
                <li className='sidebar-list-item'>
                    <div onClick={() => setActiveTab('Friend Or Foe')} style={{ backgroundColor: `${activeTab === "Friend Or Foe" ? "#C26F4D" : ""}` }}>
